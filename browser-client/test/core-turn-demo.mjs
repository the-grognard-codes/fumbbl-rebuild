...
const draft = () => ({ catalogVersion: 'bb2025-human-2026-09-25.1', ruleset: 'BB2025', rosterId: 'human', presetId: 'human-exhibition-1150', captainId: 'p1', players: Array.from({ length: 11 }, (_, index) => ({ id: `p${index + 1}`, slot: index + 1, positionId: 'lineman', skillIds: [] })), resources: { rerolls: 2, assistantCoaches: 0, cheerleaders: 0, apothecary: 0, dedicatedFans: 0 } });
