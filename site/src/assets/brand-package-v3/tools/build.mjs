...
// Keep the generated character contours; replace the perspective field at the soil edge.
...
<path fill="none" stroke="#edf5ff" stroke-width="10" stroke-dasharray="28 28" d="M174 650H946 M174 810H946"/>`;
  return { ...art, h: 906, body: `<defs><clipPath id="${id}"><path d="M0 0h${art.w}v576H0Z"/></clipPath></defs><g clip-path="url(#${id})">${art.body}</g>${pitch}` };
}
...
const description = 'An original pixel mole with round gold glasses emerging from soil above a green tabletop gridiron, with a gold left end zone, cyan right end zone, one center scrimmage line and two dotted wide-zone lines.';
...
<path fill="#070d16" d="M6 1h4v1h2v1h1v3h1v3h1v6H1V9h1V6h1V3h1V2h2Z"/>
<path fill="#101c2b" d="M6 2h4v1h2v5H4V3h2Z"/>
<path fill="#4db2ff" d="M6 2h4v1H6Z"/>
<path fill="#874a2d" d="M2 9h2V8h2v1h4V8h2v1h2v2H2Z M7 7h2v1H7Z"/>
...
</g>`, title + ' small symbol', 'Optical 16 pixel variant with round gold glasses, pixel soil, gold and cyan end zones, a center line and two dotted wide-zone lines.');
...
const illustration = await save('magic-link-complete-illustration', 640, 640, place(auth, 64, 64, 512, 512), 'A mole checking an email link', 'A friendly mole examines an envelope bearing a link symbol above a tabletop gridiron. This wordless illustration does not prescribe success or failure.');
