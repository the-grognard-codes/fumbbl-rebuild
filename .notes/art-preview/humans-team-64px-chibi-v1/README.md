...
Larger heads, helmets, hands and feet; shorter limbs; broad highlights, deep occlusion shadows and strong dark contours. The main visual reference is ../match-screen-concept-v1.png. Team colors are retained. The ogre uses warm tan skin with the blue and ivory human uniform.

- originals/: 16 full-size transparent PNG source artworks.
- sprites/: fifteen 64x64 transparent PNGs; ogre 80x80, retaining the 25% large-player allowance.
